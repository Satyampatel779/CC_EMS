    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
            ...
            <div className="relative z-10 flex min-h-screen">
                {/* Enhanced Sidebar with SidebarProvider */}
                <div className="employee-dashboard-sidebar">
                    <SidebarProvider>
                        <div className="flex">
                            <div className="glass-effect-strong rounded-r-3xl">
                                <EmployeeSidebar />
                            </div>
                        </div>
                    </SidebarProvider>
                ...
                <div className="flex-1 min-h-screen">
                    <div className="employee-dashboard-content h-full w-full p-4 md:p-6">
                        <div className="h-full glass-effect-strong rounded-3xl shadow-2xl overflow-hidden border border-white/20 hover:border-white/30 transition-all duration-500">
                            {/* Inner glow effect */}
                            <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-green-500/5 via-blue-500/5 to-teal-500/5 pointer-events-none"></div>
