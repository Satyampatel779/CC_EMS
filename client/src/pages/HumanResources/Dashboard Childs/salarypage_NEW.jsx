      ...
      <div className="flex w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-slate-900">
        ...
        <div className="flex-1 w-full max-w-none overflow-x-auto">
          <div className="w-full p-8 space-y-8">
              ...
              <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Dialog open={isSettingsDialogOpen} onOpenChange={setIsSettingsDialogOpen}>
                    ...
                    <DialogContent className="sm:max-w-[600px] bg-white/95 dark:bg-neutral-900/95 backdrop-blur-lg border border-white/20 dark:border-neutral-700/20">
                      <DialogHeader>
            ...
            <Card className="bg-white/80 dark:bg-neutral-800/80 backdrop-blur-sm border border-white/20 dark:border-neutral-700/20 shadow-lg">
              <CardHeader className="border-b border-gray-200 dark:border-neutral-700 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-neutral-800 dark:to-neutral-700 rounded-t-xl">
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="border-b border-gray-200 dark:border-neutral-700">
                        <TableHead className="font-semibold text-gray-900 dark:text-white p-4">Employee</TableHead>
                        <TableHead className="font-semibold text-gray-900 dark:text-white p-4">Basic Pay</TableHead>
                        <TableHead className="font-semibold text-gray-900 dark:text-white p-4">Hours</TableHead>
                        <TableHead className="font-semibold text-gray-900 dark:text-white p-4">Overtime</TableHead>
                        <TableHead className="font-semibold text-gray-900 dark:text-white p-4">Net Pay</TableHead>
                        <TableHead className="font-semibold text-gray-900 dark:text-white p-4">Due Date</TableHead>
                        <TableHead className="font-semibold text-gray-900 dark:text-white p-4">Status</TableHead>
                        <TableHead className="font-semibold text-gray-900 dark:text-white p-4">Actions</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {salaries.length > 0 ? (
                        salaries.map((salary) => (
                          <TableRow key={salary._id} className="border-b border-gray-100 dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-800/50 transition-all duration-200">
                            ...
                            <TableCell className="p-4 font-bold text-emerald-600 dark:text-emerald-400">
                              {formatCurrency(salary.netpay)}
                            </TableCell>
                            <TableCell className="p-4 text-gray-600 dark:text-neutral-300">
